...
public class Contact_List implements UpdateAvailable<Contact_List>, Persistable <Long>{
    ...
    public static class Builder {
        ...
        public static Builder updateBuilder(Contact_List oldRecord, Contact_List  newRecord) {
            return new Builder()
                .id(oldRecord.getId())
        ...
        public Contact_List  build() {
            Contact_List result = new Contact_List();
            result.setId(id);
    ...
    @Override
    public Contact_List  update(Contact_List  newData) {
