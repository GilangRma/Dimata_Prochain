...
@Data
@NoArgsConstructor
public class Contact_ListForm implements RecordAdapter<Contact_List> {
        ...
        @Override
        public Contact_List convertNewRecord() {
    
            return Contact_List.Builder.createNewRecord()
                    .id(id)
                    .build();
        }
        @Override
        public Contact_List convertToRecord() {
        
            return Contact_List.Builder.emptyBuilder()
