...
public class Location implements UpdateAvailable<Location>, Persistable <Long>{
    ...
    public static Location  fromRow(Row row) {
        ...
        result.setServicePercentage(ManipulateUtil.parseRow(row,SERVICE_PERCENTAGE_COL, Double .class));
        result.setTaxPercentage(ManipulateUtil.parseRow(row,TAX_PERCENTAGE_COL,  Double.class));
